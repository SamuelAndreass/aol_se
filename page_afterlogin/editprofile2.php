...
<body>
  ...
  <?php
    ...
    $q1 = mysqli_query($con,"SELECT * FROM pemilik_kos where pemilikID = '$id'");
        ...
        <div class="row">
            ...
            <div class="col-xl-8">
               ...
               if(isset($_POST['submit'])){
                ...
                $edit_query = mysqli_query($con,"UPDATE pemilik_kos SET jenisKelamin='$gender',nomorTelpon='$phone',namaUser='$username', emailUser='$email', pekerjaan='$pekerjaan', pendidikanTerakhir='$pendidikan', status='$status'WHERE pemilikID=$id ") or die("error occurred");

                if($edit_query){
                    echo "<div class='message'>
                    <p>Profile berhasil di update!</p>
                </div> <br>";
              echo "<a href='editProfile2.php'><button class='btn btn-primary'>Kembali ke setting profile</button>";
