...
?>
      ...
      <div class="container-fluid bg-primary mb-5 wow fadeIn mt-5" data-wow-delay="0.1s" style="padding: 35px;">
            <div class="container">
               <form action="menu3.php" id="cariKos" method="post">
               <div class="row g-2">
                    <div class="col-md-10">
                    ...
                    <?php 
                          ...
                          $getKos = mysqli_query($con,$queryKos);
                            if (mysqli_num_rows($getKos) > 0){
                                  ...
                                  <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                                    <div class="property-item rounded overflow-hidden" id="box_kos">
                                      <div class="position-relative overflow-hidden">
                                        <a href=<?php echo "detailKos2.php?viewKos={$row["idKos"]}";?>><img class="img-fluid" src=<?php echo '../images/' . $row['gambarKos'];?> alt=""></a>
                                        ...
                                        <div class="bg-white rounded-top text-primary position-absolute start-0 bottom-0 mx-4 pt-1 px-3" style="color:black !important;"><?php echo $row['namaKos'];?></div> <!--Sama keknya bagus buat-->
                                      </div>
                                      <div class="p-4 pb-0">
                                        <h5 class="text-primary mb-3" style="color:black !important;"><?php echo $row['hargaKos'];?></h5>
                              ...
                              document.location='../page_afterlogin/menu3.php'</script>";
