...
<body>
  <!-- template header -->
  <nav class="navbar">
  <a href="<?php echo ($_SESSION['role'] == 'pencari kos') ? 'menu2.php' : 'menu3.php'; ?>"><img src="../asset/Grey and Black Simple Minimalist Real Estate Logo (1) (1).png" class="navbar-logo" alt="logo" /></a>
<ul class="navbar-list">
    <li><a href="<?php echo ($_SESSION['role'] == 'pencari kos') ? 'faq2.php' : 'faq3.php'; ?>">FAQ</a></li>
    <li><a href="<?php echo ($_SESSION['role'] == 'pencari kos') ? 'aboutUS2.php' : 'aboutUS3.php'; ?>">Tentang Kami</a></li>
</ul>
...
<div class="box-pesan">
  ...
  <path d="M11.251.068a.5.5 0 0 1 .227.58L9.677 6.5H13a.5.5 0 0 1 .364.843l-8 8.5a.5.5 0 0 1-.842-.49L6.323 9.5H3a.5.5 0 0 1-.364-.843l8-8.5a.5.5 0 0 1 .615-.09z"/>
      ...
      <div class="button-wrapper2">
        <button class="button-ajukan" onclick="windows.href.location='payment.php'">Ajukan Sewa</button>
      </div>
